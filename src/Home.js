...
import imagusere from "./images/11.png";
                  ...
                  <div className="boxes">
                    ...
                    <div className="box-data">
                      ...
                      <div>
                        ...
                        <img
                          src={delivery}
                          className="omagesetting-icon123"
                          width="30"
                          height="30"
                          alt=""
                        />
                  ...
                  <div className="boxes mt-3">
                    ...
                    <div className="box-data">
                      <div>
                        ...
                        <img
                          src={rating}
                          className="margin-boixes-image34"
                          width="30"
                          height="30"
                          alt=""
                        />
                    ...
                    <div className="box-data">
                      <div>
                        ...
                        <img
                          src={revenueww}
                          className="margin-boixes-image22"
                          width="30"
                          height="30"
                          alt=""
                        />
                  ...
                  <div className="nameandpaisa">
                    <div className="bnsjfd">
                      <img
                        ...
                        alt=""
                      />
                      <p className="text123">Shine</p>
                    </div>
                    <div>
                      <p className="top-customers-numbers">$49,137</p>
                    </div>
                  </div>
              ...
              <div class="table-wrapper">
                <table class="fl-table">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <button type="button" class=" button12345 rounded-pill">
                          Squad
                        </button>
                      </td>
                      ...
                      <td>
                        <div className="tablecustomer997">
                          ...
                          <div className="ml-2">
                            <p className="text23">Sarah</p>
                            <p className="text223">F-10 Islmabad</p>
                            <p className="text223">+91-2345789</p>
                          </div>
                        </div>
                      </td>
                      <td>2345</td>
                      ...
                      <td>
                        ...
                        <button
                          type="button"
                          class=" button123456 rounded-pill"
                        >
                          Squad
                        </button>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="tablecustomer997">
                          ...
                          <div className="ml-2">
                            <p className="text23">Talha Ali</p>
                            <p className="text223">F-10 Islmabad</p>
                            <p className="text223">+91-2345789</p>
                          </div>
                        </div>
              ...
              <div className="maindiv-tqm">
                <div className="quality-performance">
                  ...
                  <div>
                    {/* <button
                  type="button"
                  class="btn btn-primary custom-loofr"
                  data-toggle="modal"
                  data-target=".bd-example-modal-lg"
                ></button> */}

                    <div
                      class="modal fade moeaer bd-example-modal-lg"
                      tabindex="-1"
                      role="dialog"
                      aria-labelledby="myLargeModalLabel"
                      aria-hidden="true"
                    >
                      <div class="modal-dialog moeaer modal-lg">
                        <div class="modal-content  padding-model">
                          ...
                          <div className="mt-3">
                            <p className="modeltitle">Order Acceptance</p>
                            <div className="textformodal">
                              <p className="">Phase 1 Goal Limit</p>
                              <p className="">Phase 2 Goal Limit</p>
                              <p className="">Ultimate Goal Limit</p>
                            </div>
                            <div className="derpjai">
                              <div class="dropdown show">
                                <a
                                  class="btn abnv dropdown-toggle"
                                  href="#"
                                  role="button"
                                  id="dropdownMenuLink"
                          ...
                          <div className="mt-3">
                            <p className="modeltitle">Reaching Vendor</p>
                            <div className="textformodal">
                              <p className="">Phase 1 Goal Limit</p>
                              <p className="">Phase 2 Goal Limit</p>
                              <p className="">Ultimate Goal Limit</p>
                          ...
                          <div className="mt-3">
                            <p className="modeltitle">Delivering Order</p>
                            <div className="textformodal">
                              <p className="">Phase 1 Goal Limit</p>
                              <p className="">Phase 2 Goal Limit</p>
                              <p className="">Ultimate Goal Limit</p>
                          ...
                          <div className="mt-3">
                            <p className="modeltitle">Clearing Payments</p>
                            <div className="textformodal">
                              <p className="">Phase 1 Goal Limit</p>
                              <p className="">Phase 2 Goal Limit</p>
                              <p className="">Ultimate Goal Limit</p>
                          ...
                          <div className="buttonupdate">
                            <button
                              type="button"
                              class="btn btn-danger mt-5 w-40 vutajdf rounded-pill"
                              data-dismiss="modal"
                            >
                              Update
                            </button>
